...
class SigProView extends SigProViewBase
{
	...
	public function __construct($config = array())
	{
		...
		if ($document->getType() == 'html')
		{
			...
			$document->addStyleSheet(JURI::root(true).'/administrator/components/com_sigpro/css/fonts.css?v=3.0.7');
			$document->addStyleSheet(JURI::root(true).'/administrator/components/com_sigpro/css/style.css?v=3.0.7');
			...
			$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/chosen.jquery.min.js?v=3.0.7');
			$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/script.js?v=3.0.7');
			...
			{
				// Load SwipeBox
				$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/swipebox/lib/ios-orientationchange-fix.js?v=3.0.7');
				$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/swipebox/src/js/jquery.swipebox.min.js?v=3.0.7');
				$document->addStyleSheet(JURI::root(true).'/administrator/components/com_sigpro/js/swipebox/src/css/swipebox.min.css?v=3.0.7');
				...
				$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/plupload/plupload.js?v=3.0.7');
				...
				$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/plupload/jquery.plupload.queue/jquery.plupload.queue.js?v=3.0.7');
				...
				if ($lang)
				{
					$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/plupload/i18n/'.$lang.'.js?v=3.0.7');
				}
			...
			if ($view == 'media')
			{
				...
				$document->addStyleSheet(JURI::root(true).'/administrator/components/com_sigpro/js/elfinder/css/elfinder.min.css?v=3.0.7');
				$document->addStyleSheet(JURI::root(true).'/administrator/components/com_sigpro/js/elfinder/css/theme.css?v=3.0.7');
				$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/elfinder/js/elfinder.min.js?v=3.0.7');
				...
				if ($lang)
				{
					$document->addScript(JURI::root(true).'/administrator/components/com_sigpro/js/elfinder/js/i18n/elfinder.'.$lang.'.js?v=3.0.7');
