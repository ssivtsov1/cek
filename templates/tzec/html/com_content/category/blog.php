...
if(JRequest::getVar('start', null)){
	//joomla sys
    $pagination = $this->get('Pagination');
    $curr_page =$pagination->pagesCurrent;
    $doc = JFactory::getDocument();
    $description = $doc->getMetaData( 'description' );
    if($description!=''){
        $doc->setMetaData( 'description', $description.' - стр.'.$curr_page);    
    }
    $doctitle = $doc->getTitle();
    if($doctitle!=''){
       $doc->setTitle($doctitle.' - стр.'.$curr_page); 
    }
}
?>
<div class="blog<?php echo $this->pageclass_sfx; ?>">
	...
	<?php if (!empty($this->intro_items)) : ?>
		<?php foreach ($this->intro_items as $key => &$item) : ?>
			...
			<?php endif; ?>
			<div class="col-lg-<?php echo round((12 / $this->columns)); ?> col-md-<?php echo round((12 / $this->columns)); ?> col-sm-12 col-xs-12">
				<div
